...
**The app:** open the GitHub Pages site for this repo (or run `python3 -m http.server 8123` in this folder and open http://localhost:8123). Check the recipes you want, set how many breakfasts, lunches, and dinners the week needs, and it generates a Costco list — quantities scaled and summed, grouped by store section, with the non-Costco stragglers and check-the-pantry staples split out. Tap any recipe card to read the full recipe.
